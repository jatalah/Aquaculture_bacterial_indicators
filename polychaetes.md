...
```
    ...
    ## Run 1 stress 0.130493 
    ## Run 2 stress 0.1270236 
    ## Run 3 stress 0.08114942 
    ## Run 4 stress 0.08181599 
    ## Run 5 stress 0.08223424 
    ## Run 6 stress 0.08114954 
    ## Run 7 stress 0.1277167 
    ## Run 8 stress 0.081816 
    ## Run 9 stress 0.08044536 
    ## ... New best solution
    ## ... Procrustes: rmse 0.006504541  max resid 0.02258195 
    ## Run 10 stress 0.08114942 
    ## Run 11 stress 0.08346721 
    ## Run 12 stress 0.0804256 
    ## ... New best solution
    ## ... Procrustes: rmse 0.002217288  max resid 0.007702243 
    ## ... Similar to previous best
    ## Run 13 stress 0.08331201 
    ## Run 14 stress 0.08114943 
    ## Run 15 stress 0.08331201 
    ## Run 16 stress 0.08223417 
    ## Run 17 stress 0.08042558 
    ## ... New best solution
    ## ... Procrustes: rmse 6.286689e-05  max resid 0.0002132435 
    ## ... Similar to previous best
    ## Run 18 stress 0.08223417 
    ## Run 19 stress 0.08223418 
...
```
    ...
    ## Farm           1    0.1875 0.18745  5.1873 0.05635 0.0131 *  
    ## Distance:Farm  3    0.1850 0.06166  1.7063 0.05560 0.1481    
...
```
    ...
    ## 1     0m vs 50m  1 0.9709690 17.913217 0.6417468   0.004      0.024   .
    ## 2    0m vs 250m  1 1.6477067 58.039808 0.8530272   0.003      0.018   .
    ## 3   0m vs 2000m  1 1.5316848 33.213406 0.7685903   0.003      0.018   .
    ## 4   50m vs 250m  1 0.2932122  5.990758 0.3746388   0.004      0.024   .
    ## 5  50m vs 2000m  1 0.1806801  2.710014 0.2132188   0.017      0.102    
...
| 0m vs. 50m    | Paraonidae    |    0.05 | 0.04 |  1.31 | 0.00 | 1.04 |  0.48 | 0.24 |
...
| 0m vs 250m    | Dorvilleidae  |    0.04 | 0.03 |  1.20 | 1.05 | 0.73 |  0.48 | 0.56 |
...
| 0m vs 2000m   | Dorvilleidae  |    0.05 | 0.04 |  1.23 | 1.05 | 0.22 |  0.51 | 0.03 |
...
| 50m vs 250m   | Dorvilleidae  |    0.03 | 0.02 |  1.23 | 0.86 | 0.73 |  0.43 | 0.95 |
| 50m vs 250m   | Cossuridae    |    0.03 | 0.03 |  1.19 | 0.89 | 1.74 |  0.51 | 0.97 |
| 50m vs 250m   | Cirratulidae  |    0.03 | 0.02 |  1.34 | 1.00 | 1.87 |  0.59 | 0.89 |
| 50m vs 250m   | Lumbrineridae |    0.04 | 0.03 |  1.35 | 0.67 | 1.68 |  0.66 | 0.20 |
...
| 50m vs. 2000m | Cossuridae    |    0.04 | 0.03 |  1.28 | 0.89 | 1.72 |  0.46 | 0.68 |
| 50m vs. 2000m | Cirratulidae  |    0.02 | 0.03 |  0.90 | 1.00 | 1.50 |  0.54 | 0.97 |
| 50m vs. 2000m | Lumbrineridae |    0.03 | 0.03 |  1.07 | 0.67 | 1.10 |  0.61 | 0.71 |
| 50m vs. 2000m | Glyceridae    |    0.02 | 0.02 |  0.74 | 0.86 | 0.92 |  0.67 | 0.99 |
...
```
    ...
    ## Groups     3 0.030015 0.0100051 1.1843    999  0.346
    ## Residuals 20 0.168968 0.0084484                     
    ## 
    ## Pairwise comparisons:
    ## (Observed p-value below diagonal, permuted p-value above diagonal)
    ##             0m      50m     250m 2000m
    ## 0m             0.465000 0.395000 0.084
    ## 50m   0.457807          0.279000 0.973
    ## 250m  0.369678 0.267179          0.011
